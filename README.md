# Berkut Cyber Base v1.0.1 🛡️

![Без имени](https://github.com/user-attachments/assets/5fcc88ac-db4a-4b3a-906f-3d1fe5874e3d)
...
### Шаги для установки
1. Скачайте файл `Berkut Cyber Base Setup 1.0.1.exe` из раздела [Releases](https://github.com/BerkutSolutions/berkut-cyber-base/releases).
