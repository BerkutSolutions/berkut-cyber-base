# Berkut Cyber Base v1.0.4 🛡️

![prog](https://github.com/user-attachments/assets/9c3ef192-29b6-4b02-b1d9-adddbc19966a)
...
- Описание уязвимостей языков программирования, методы поиска и защиты.
...
- Раздел "Стеганография" с описанием методов скрытия данных.
...
### Шаги для установки
1. Скачайте файл `Berkut Cyber Base Setup 1.0.3.exe` из раздела [Releases](https://github.com/BerkutSolutions/berkut-cyber-base/releases).
