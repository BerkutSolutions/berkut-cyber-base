    ...
    <div class="osint-container">
      ...
      <div class="osint-description">
        ...
        <ul>
          ...
          <li>В России доступ к некоторым OSINT-инструментам может быть ограничен из-за блокировок, поэтому рекомендуется использовать VPN или прокси для работы с международными сервисами.</li>
