      ...
      <div class="osi-table-container">
        <table class="osi-table">
          ...
          <tbody>
            ...
            <tr>
              <td>ViPNet SafePoint</td>
              <td>Решение для защиты АСУ ТП, обеспечивающее контроль трафика и предотвращение атак на промышленные системы.</td>
              <td>Промышленные предприятия, энергетика, АСУ ТП.</td>
            </tr>
            <tr>
            ...
            <tr>
              <td rowspan="2">ОКБ САПР</td>
              <td>СКАД Сигнатура</td>
              <td>Аппаратно-программный комплекс для защиты от несанкционированного доступа и контроля целостности.</td>
              <td>Государственные структуры, военные организации, объекты КИИ.</td>
            </tr>
            <tr>
              <td>Янтарь</td>
              <td>Модуль доверенной загрузки для защиты оборудования на этапе старта ОС.</td>
              <td>Рабочие станции, серверы в государственных и промышленных системах.</td>
            </tr>
            <tr>
            ...
            <tr>
              <td rowspan="2">ООО "Юзергейт"</td>
              <td>UserGate</td>
              <td>Многофункциональный межсетевой экран (NGFW) с функциями UTM, фильтрации трафика и защиты от угроз.</td>
              <td>Корпоративные сети, объекты КИИ, провайдеры.</td>
            </tr>
            <tr>
              <td>UserGate Proxy & Firewall</td>
              <td>Решение для фильтрации веб-трафика, контроля доступа и защиты сети.</td>
              <td>Малый и средний бизнес, образовательные учреждения.</td>
            </tr>
          </tbody>
        </table>
